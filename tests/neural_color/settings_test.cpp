...
int main()
{
	...
	Require(SettingsJson(Registry::Instance().Snapshot().settings) == saved, "save/load round trip");
	Require(Call({ { "action", "reset_experiments" } })["settings"] == saved, "experiment reset retains ordinary setting");
