...
namespace VRFrustumTelemetry
{
	...
	using VRNativeFrustum::ArrayAddress;
	using VRNativeFrustum::NativeHeader;
	using VRNativeFrustum::NativeOperator;
	using VRNativeFrustum::ReadBound;
	using VRNativeFrustum::ReadHeader;
	using VRNativeFrustum::ReadInstruction;
	using VRNativeFrustum::ReadOperator;
	struct Structure
	{
		NativeHeader header;
