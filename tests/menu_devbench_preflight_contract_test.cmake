...
set(_frustum_fast_path_found FALSE)
set(_frustum_fast_path_verification_found FALSE)
set(_frustum_telemetry_detail_enabled_found FALSE)
...
foreach(_index RANGE 0 ${_action_last})
    ...
    elseif(_action STREQUAL "set_frustum_fast_path_enabled")
        set(_frustum_fast_path_found TRUE)
    elseif(_action STREQUAL "set_frustum_fast_path_verification")
        set(_frustum_fast_path_verification_found TRUE)
    elseif(_action STREQUAL "set_frustum_telemetry_detail_enabled")
        set(_frustum_telemetry_detail_enabled_found TRUE)
...
if(NOT _frustum_telemetry_detail_enabled_found)
    message(
        FATAL_ERROR
        "Menu DevBench schema is missing set_frustum_telemetry_detail_enabled"
    )
endif()
if(NOT _frustum_fast_path_found OR NOT _frustum_fast_path_verification_found)
    message(FATAL_ERROR "Menu DevBench schema is missing frustum experiment controls")
endif()
file(READ "${PROJECT_ROOT}/src/Features/Upscaling/VRRenderScaleDevBenchBridge.cpp" _render_scale_bridge)
string(FIND "${_render_scale_bridge}" "\"frustumFastPath\", VRFrustumFastPath::GetStatus()" _fast_path_receipt)
if(_fast_path_receipt EQUAL -1)
    message(FATAL_ERROR "Saved render-scale health must retain the frustum experiment mode and counters")
endif()
