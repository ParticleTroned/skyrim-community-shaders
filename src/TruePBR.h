...
public:
	...
	{
		return { 15,
			T("menu.performance_tuning.feature.true_pbr.comparison_label", "Off"),
			T("menu.performance_tuning.feature.true_pbr.comparison_details", "True PBR material shading is switched off.") };
	}
