...
string(FIND
    ...
    _parameter_core_alias_documentation_position
)
if(_parameter_core_alias_documentation_position EQUAL -1)
    message(FATAL_ERROR
        "Streamline documentation does not describe the trusted _nvngx.dll alias"
    )
endif()
