...
-   **[Capture and Calibration Evidence](./capture-calibration.md)** - VR stereo sequences, DevBench capture, manifests, and timing protocol
...
-   **[Preset Automation Evidence System](./preset-automation/README.md)** - Feature dossiers, interaction records, benchmark provenance, preset policies, and decisions for assisted preset generation
