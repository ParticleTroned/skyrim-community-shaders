[CmdletBinding()]
param(
    [string]$PolicyPath = (Join-Path $PSScriptRoot '..\docs\development\preset-automation\unified-preset-policy.json'),
...
notes=PROVISIONAL unified $Tier preset generated from docs/development/preset-automation/unified-preset-policy.json
nexusDescription=
url=
hasCustomURL=false
lastNexusQuery=
