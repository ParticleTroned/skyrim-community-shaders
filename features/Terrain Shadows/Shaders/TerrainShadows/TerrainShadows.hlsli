#ifndef __TERRAIN_SHADOWS_HLSLI__
#define __TERRAIN_SHADOWS_HLSLI__
...
namespace TerrainShadows
{
	...
	static const float SelfShadowBias = 1024.0;
	...
	float GetTerrainShadow(const float3 worldPos, SamplerState samp)
	{
		...
		// Cap the z blur by the bias so lit flat terrain stays lit.
...
#endif  // __TERRAIN_SHADOWS_HLSLI__
