...
if(MODE STREQUAL "AIO")
    if(NOT DEFINED FEATURE_PATHS_FILE)
        message(FATAL_ERROR "CleanupStaleEntries.cmake AIO mode requires FEATURE_PATHS_FILE")
    endif()
    if(NOT EXISTS "${FEATURE_PATHS_FILE}")
        message(FATAL_ERROR "CleanupStaleEntries.cmake could not find FEATURE_PATHS_FILE: ${FEATURE_PATHS_FILE}")
    endif()
...
elseif(MODE STREQUAL "SHADERS")
    if(NOT DEFINED FEATURE_SHADER_PATHS_FILE)
        message(FATAL_ERROR "CleanupStaleEntries.cmake SHADERS mode requires FEATURE_SHADER_PATHS_FILE")
    endif()
    if(NOT EXISTS "${FEATURE_SHADER_PATHS_FILE}")
        message(FATAL_ERROR "CleanupStaleEntries.cmake could not find FEATURE_SHADER_PATHS_FILE: ${FEATURE_SHADER_PATHS_FILE}")
    endif()
