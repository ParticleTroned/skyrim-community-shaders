...
void TerrainBlending::DrawSettings()
{
	...
	ImGui::SliderFloat("Blend Strength", &settings.BlendStrength, 0.125f, 2.5f, "%.3f");
	if (auto _tt = Util::HoverTooltipWrapper()) {
		ImGui::Text("Scales the terrain blend range. Higher values more blending and transparency");
	}
	ImGui::Spacing();
