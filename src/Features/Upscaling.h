...
public:
	...
	**/
	...
	eastl::unique_ptr<Texture2D> vrKnownMenuSceneBeforeComposite;    // full stereo render-scale scene before kMENUBG composition
	eastl::unique_ptr<Texture2D> vrKnownMenuBackgroundComposite;     // full stereo render-scale kMENUBG menu layer
	uint32_t vrKnownMenuSceneBeforeCompositeFrame = 0;
	uint32_t vrKnownMenuBackgroundCompositeFrame = 0;
	struct RetiredVRIntermediateTextures
	{
		...
		eastl::unique_ptr<Texture2D> knownMenuSceneBeforeComposite;
		eastl::unique_ptr<Texture2D> knownMenuBackgroundComposite;
	};
