...
namespace
{
  ...
  "inputSchema":{
    ...
    "properties":{
      ...
      "mode":{"oneOf":[{"type":"string","enum":["full_resolution","foveated","reduced_resolution"]},{"type":"integer","minimum":0,"maximum":2}],"description":"NR execution mode: full output resolution, shared FOV masks, or reduced input before DLSS upscaling. Character isolation can combine with every mode."},
      "fovOnly":{"type":"boolean","description":"Limit full-resolution NR to the existing FOV masks."},
