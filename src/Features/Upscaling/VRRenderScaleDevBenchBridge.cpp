...
namespace VRRenderScaleDevBenchBridge
{
  ...
  "outputSchema":{"type":"object","properties":{"neuralRendering":{"type":"object","properties":{"characterRendering":{"type":"object","properties":{"runtime":{"type":"object","properties":{"lastPreparationFailure":{"type":["object","null"],"properties":{"sequence":{"type":"integer"},"detail":{"type":"string"},"frame":{"type":"integer"},"sourceWorldFrame":{"type":"integer"},"capturedFrame":{"type":"integer"},"generation":{"type":"integer"},"featureSlot":{"type":"integer"},"eye":{"type":"integer"},"requestedCategories":{"type":"integer"},"capturedCategories":{"type":"integer"}}}}}}}}}}},
  "inputSchema":{
    "type":"object",
    "properties":{
