...
namespace MotionBlur
{
	...
	{
		float4 screenPosition = mul(fb.CameraViewProjUnjittered, a_wsPosition);
		float4 previousScreenPosition = mul(fb.CameraPreviousViewProjUnjittered, a_previousWSPosition);
