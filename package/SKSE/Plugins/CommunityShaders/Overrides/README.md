# CSX - Settings Override System

The Settings Override System allows mods to provide custom configuration overrides for CSX features without modifying the main settings file. This enables better mod compatibility and allows multiple mods to adjust different settings independently.
...
1. **Discovery**: Override files are automatically discovered when CSX loads
...
-   Navigate to the "Overrides" tab in the CSX menu
...
-   Look for errors in the CSX log
...
CSX logs override discovery and application:
