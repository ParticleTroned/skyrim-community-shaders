...
struct LightPicker
{
	...
	struct PickedMesh
	{
		...
		RE::FormID baseLocalFormId = 0;  // plugin-local base ID (supports full and light plugins)
	...
	/** @brief Formats a plugin-local FormID + defining plugin into an LP entry string ("0x{localID}~Plugin.esp"). */
