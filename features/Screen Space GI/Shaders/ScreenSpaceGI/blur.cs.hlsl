...
[numthreads(8, 8, 1)] void main(const uint2 dtid
	...
	for (uint i = 0; i < numSamples; i++) {
		...
		// Project view-space blur offsets. In VR, samples that leave the current eye
		// are reprojected into the other eye instead of falling back to a flat pixel kernel.
