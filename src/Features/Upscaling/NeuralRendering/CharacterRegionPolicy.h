...
namespace NeuralRendering
{
	...
	/** One actor's view-local semantic enclosure and perceptual priority inputs. */
	...
	namespace CharacterRegionPolicy
	{
		 ...
		 * player distance, projected face size, then stable actor ID so the view
		 * uses stable decisions from the view inputs.
		 */
