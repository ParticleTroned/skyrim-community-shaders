...
void State::Draw()
{
	...
	if (shaderCache->IsEnabled()) {
		...
		globals::features::upscaling.ApplyPendingPerfModeRenderTargetRecreate();
...
{
	(void)globals::features::upscaling.AdjustVRRenderScaleRenderTargetProperties(a_target, a_properties);
