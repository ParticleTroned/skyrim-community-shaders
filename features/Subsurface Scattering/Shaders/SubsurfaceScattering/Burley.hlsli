...
float4 BurleyNormalizedSS(uint2 DTid, float2 texCoord, float sssAmount, bool humanProfile, bool isFemale, float4 originalSceneColor)
{
	...
	if (humanProfile) {
		float3 base0 = originalSceneColor.xyz;
