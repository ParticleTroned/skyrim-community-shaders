...
namespace VRRenderScaleDevBenchBridge
{
  ...
  "outputSchema":{"type":"object","properties":{"neuralRendering":{"type":"object","properties":{"characterRendering":{"type":"object","properties":{"runtime":{"type":"object","properties":{"lastPreparationFailure":{"type":["object","null"],"properties":{"sequence":{"type":"integer"},"detail":{"type":"string"},"frame":{"type":"integer"},"sourceWorldFrame":{"type":"integer"},"capturedFrame":{"type":"integer"},"generation":{"type":"integer"},"featureSlot":{"type":"integer"},"eye":{"type":"integer"},"requestedCategories":{"type":"integer"},"capturedCategories":{"type":"integer"}}},"eyes":{"type":"array","items":{"type":"object","properties":{"effectiveCategoryMask":{"type":"integer"},"effectiveCategoryStrengths":{"type":"array","items":{"type":"number"},"minItems":3,"maxItems":3},"maskRoiPlanningCpuMs":{"type":"number"}}}}}}}}}}}},
  "inputSchema":{
    "type":"object",
    "properties":{
