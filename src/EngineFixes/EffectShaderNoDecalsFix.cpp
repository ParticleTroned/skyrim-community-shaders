...
bool EffectShaderNoDecalsFix::BSEffectShaderProperty_SetupGeometry::thunk(
	RE::BSEffectShaderProperty* a_property,
	RE::BSGeometry* a_geometry)
{
	const bool result = func(a_property, a_geometry);

	if (a_property && a_geometry &&
		a_property->flags.any(RE::BSShaderProperty::EShaderPropertyFlag::kSoftEffect)) {
